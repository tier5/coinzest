...
class UpdraftPlus_Addons_Migrator {
	...
	public function updraftplus_admin_enqueue_scripts() {
		...
		wp_enqueue_script('select2', UPDRAFTPLUS_URL."/includes/select2/select2.min.js", array('jquery'), '4.0.2');
		wp_deregister_style('select2');
		wp_enqueue_style('select2', UPDRAFTPLUS_URL."/includes/select2/select2.min.css", array(), '4.0.2');
	}
